...
The best way to send feedback is to file an issue at https://github.com/mrfunnyshoes/limette/issues.
...
3. The pull request should work for Python 2.7, 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.org/mrfunnyshoes/limette/pull_requests
