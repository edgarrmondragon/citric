...
and adheres to [Calendar Versioning](https://calver.org/)


## [Unreleased](https://github.com/edgarrmondragon/citric/compare/0.10.0...HEAD)

### Added

* [#1079](https://github.com/edgarrmondragon/citric/pull/1079) Add `get_db_version` method to RPC client

### Documentation

* [#1057](https://github.com/edgarrmondragon/citric/pull/1057) Document `conda install` option
